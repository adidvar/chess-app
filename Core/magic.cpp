...
bitboard_t log2_64 (bitboard_t value)
{
    ...
    value |= value >> 16;
    value |= value >> 32;
    return tab64[((bitboard_t)((value - (value >> 1))*0x07EDD5E59A4E28C2)) >> 58];
}
...
template<typename T>
static bitboard_t find_magic(bitboard_t sq,bitboard_t mask, bitboard_t (*attack)(bitboard_t,bitboard_t), bitboard_t hash_ref[64][64], T& random)
{
    using namespace std;
