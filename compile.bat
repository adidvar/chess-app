...
g++ Chess.o  Chessboard.o ChessController.o MyBot.o UI.o main.o -LD:\Developing\SFML32\lib -lsfml-graphics-s -lfreetype -lsfml-window-s -lopengl32 -lgdi32 -lsfml-system-s -lwinmm -static-libgcc -m32 -mfpmath=sse -Ofast -flto -march=native
pause
